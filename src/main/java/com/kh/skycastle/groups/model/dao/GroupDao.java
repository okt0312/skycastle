...
*/
	...
	public ArrayList<Dips> selectDipsList(SqlSessionTemplate sqlSession, int userNo){
		return (ArrayList)sqlSession.selectList("groupsMapper.selectDipsList", userNo);
	}
