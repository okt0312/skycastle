...
<body>
	<div id="layoutSidenav">
		<jsp:include page="common/adminSidebar.jsp"/>
                ...
                <form action="">
                	<table id="chTable" align="center" style="text-align:center; width: 100%; height: 50px;" border="1px solid black">
	                    <tr>
	                        <td style="background-color: rgb(224, 216, 216); font-weight: bold; width: 30%;">예약일</td>
	                        <td style="width: 25%"><input type="date">&nbsp;~&nbsp;<input type="date"></td>
	                        <td style="background-color: rgb(224, 216, 216); font-weight: bold; width: 30%;">예약 공간</td>
	                        <td>
                ...
                <table id="chTable" align="center" style="width: 100%; text-align: center;">
