	                            ...
	                            <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div></a>
	                                <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
	                                    <nav class="sb-sidenav-menu-nested nav">
	                                        <a class="nav-link" href="layout-static.html">회원 조회</a>
	                                        <a class="nav-link" href="layout-sidenav-light.html">등급 관리</a>
	                                        <a class="nav-link" href="layout-sidenav-light.html">신고 관리</a>
	                                        <a class="nav-link" href="layout-sidenav-light.html">블랙리스트 관리</a>
	                                    </nav>
	                                </div>
	                        <!-- 소모임관리 -->
