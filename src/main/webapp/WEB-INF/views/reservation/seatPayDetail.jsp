...
<jsp:include page="../common/menubar.jsp"/>
    <div class="content">
        <div class="content_1">
	        ...
	        <br>
	        <p style="font-size: 20px; font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;선택공간 세부사항</p>
	        <div id="seat">
	            <div style="font-weight: bold; font-size:18px;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span>13</span>번좌석</div>
	            <div>
            	...
            	<div id="payD">
                	<div>
	                	...
	                	<div id="detail">
	                        ...
	                        <div>
	                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                            <span style="font-size: 15px;">회원가입 5%할인 쿠폰</span>
	                        </div>
	                        <div>
	                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                            <span style="font-size: 15px;">브론즈 상시할인 2%</span>
	                        </div>
                		</div>
            		</div>
            		<br clear="both">
