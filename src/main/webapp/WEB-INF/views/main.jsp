    ...
    <div class="instagram-feed-area">
        ...
        <div class="instagram-slides owl-carousel">
            ...
            <div class="single-insta-feed">
                <img src="${pageContext.servletContext.contextPath}/resources/bootstrap/img/instagram-img/1.png" alt="">
                <!-- Hover Effects -->
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="${pageContext.servletContext.contextPath}/resources/bootstrap/img/instagram-img/2.png" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i class="fa fa-instagram"></i></a>
                </div>
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="${pageContext.servletContext.contextPath}/resources/bootstrap/img/instagram-img/3.png" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i class="fa fa-instagram"></i></a>
                </div>
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="${pageContext.servletContext.contextPath}/resources/bootstrap/img/instagram-img/4.png" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i class="fa fa-instagram"></i></a>
                </div>
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="${pageContext.servletContext.contextPath}/resources/bootstrap/img/instagram-img/5.png" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i class="fa fa-instagram"></i></a>
                </div>
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="${pageContext.servletContext.contextPath}/resources/bootstrap/img/instagram-img/6.png" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i class="fa fa-instagram"></i></a>
                </div>
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="${pageContext.servletContext.contextPath}/resources/bootstrap/img/instagram-img/7.png" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i class="fa fa-instagram"></i></a>
                </div>
